...
git config --global user.name "Alvim1234"
git config --global user.email "lucasalvimetec@gmail.com"

:: Adiciona o repositório remoto (só executa se já não estiver adicionado)
git remote get-url origin >nul 2>&1
if errorlevel 1 (
    git remote add origin "https://github.com/Alvim1234/RepositorioRemotoNuvem.git"
)
